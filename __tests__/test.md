# This file should be ignored by prettier
...
and regular than that of the individual languages. The new common language will
be more simple and regular than the existing European languages. It will be as
simple as Occidental; in fact, it will be Occidental. To an English person, it
will seem like simplified English, as a sceptical Cambridge friend of mine told
me what Occidental is. The European languages are members of the same family.
...
language would be desirable: one could refuse to pay expensive translators. To
...
To an English person, it will seem like simplified English, as a sceptical
...
music, sport, etc, Europe uses the same vocabulary. The languages only differ in
...
English, as a sceptical Cambridge friend of mine told me what Occidental is. The
...
English person, it will seem like simplified English, as a sceptical Cambridge
...
etc, Europe uses the same vocabulary. The languages only differ in their
grammar, their pronunciation and their most common words. Everyone realizes why
...
of the resulting language is more simple and regular than that of the individual
...
as a sceptical Cambridge friend of mine told me what Occidental is. The European
...
that of the individual languages. The new common language will be more simple
...
like simplified English, as a sceptical Cambridge friend of mine told me what
...
be desirable: one could refuse to pay expensive translators. To achieve this, it
would be necessary to have uniform grammar, pronunciation and more common words.
If several languages coalesce, the grammar of the resulting language is more
simple and regular than that of the individual languages. The new common
language will be more simple and regular than the existing European languages.
It will be as simple as Occidental; in fact, it will be Occidental. To an
...
### Text to be split: level 2 again
...
### Text to be split: level 3 again
